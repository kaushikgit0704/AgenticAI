...
class StockPriceTool(BaseTool):
    ...
    description: str = "Fetches the current stock price, fiftytwoweekhigh and for a given stock symbol."
    ...
    def _run(self, symbol: str) -> str:
        ...
        return StockPriceToolOutput(
            ...
            recentclosingprice=str(stock.history(period='1d', interval='1m')['Close'].iloc[-1]) if not history.empty else 'N/A'
        )
